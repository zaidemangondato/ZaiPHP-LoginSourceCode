...
<section>
	<div class="container-fluid">
		<div style="padding: 10px;">
			<h4 align="center">Sign In - Demo Dev</h4>
		</div>
					...
					<div class="card-body">
						<form method="post">	
							<div class="form-group">
								...
								<input type="text" class="form-control" name="txtusername" placeholder="username123" required="" value="">
							</div>
							<div class="form-group">
